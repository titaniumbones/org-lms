...
(defvar org-lms-property-equivs
  '(("CANVASID" "id" 'string-to-number 'number-to-string)
    ("DUE_AT" "due_at" 'identity 'identity)
    ("ASSIGNMENT_WEIGHT" "points_possible" 'identity 'identity)
    ("GRADING_TYPE" "grading_type" 'o-l-list-to-prop 'o-l-prop-to-list)
    ("CANVAS_SUBMISSION_TYPES" "submission_types" 'o-l-list-to-prop 'o-l-prop-to-list)
    ("OL_PUBLISH" "published")
      ))
